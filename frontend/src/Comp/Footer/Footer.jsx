  ...
  return (
    <>
      <div className={styled.seconddiv}>
        ...
        <h5>CONTACT US</h5>
        <hr />
        <p className={styled.hoverEffect}>   <i class="bi bi-house-heart-fill"></i>Office Location: Plot no. 417, Udyog Vihar Phase III, Gurgaon,Haryana ,India
        </p>
        <p className={styled.hoverEffect}> <i class="bi bi-envelope-fill"> </i> shop@bellavitaorganic.com</p>
        <p className={styled.hoverEffect}><i class="bi bi-telephone-fill"></i> +91 9311732440</p>
        <p className={styled.hoverEffec}>Timing:9:00 AM To 9:00 PM , Monday To Sunday</p>
       </div>
       ...
       <div>
          ...
          <hr />
          <p className={styled.hoverEffec}>Sign up here to get the latest news, updates and special offers delivered to your inbox.</p>
          <p className={styled.hoverEffec}>Plus, you'll be the first to know about our discounts!</p>
          <input className="fo" type="search" placeholder="Enter Email Address" />
          <br /><br />
      ...
      <Row>
        <Col md="4" className={styled.footercopywright}>
         <img  src="https://cdn.shopify.com/s/files/1/0054/6665/2718/files/payments-stripe-footer_256x256_e_400x.png?v=1650369513" alt="socialmed" />
        </Col>
